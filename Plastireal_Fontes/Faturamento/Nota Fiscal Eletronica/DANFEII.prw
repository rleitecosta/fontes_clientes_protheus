...
#DEFINE MAXCODPRD  045                                                // Máximo de caracteres do codigo de produtos/servicos
...
Else
	...
	oDANFE := Nil
EndIf
//Chamada para rotina de retorno da NFS para a API Techprod
If SF2->F2_XAFXSTA <> 'I'
	U_WSRESTNF(SF2->F2_DOC,SF2->F2_SERIE,.F.) //(Documento, Série, Lote)
Endif

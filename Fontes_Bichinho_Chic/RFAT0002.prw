...
(cAlias)->(dbGotop())
	...
	oPrint:Say(nLin,1500,'Quant.',oFtA10n)   //oPrint:Say(nLin,0520,'Unid.',oFtA10n)
	oPrint:Say(nLin,1900,'Unid.',oFtA10n)    //oPrint:Say(nLin,0630,'Descri็ใo',oFtA10n)
	nLin += 40
 ...
 Do While (cAlias)->(!EOF())
		...
		oPrint:Say(nLin,1500,transform((cAlias)->C6_QTDVEN,PesqPict("SC6","C6_QTDVEN")),oFtC09)//oPrint:Say(nLin,0340,transform((cAlias)->C6_QTDVEN,PesqPict("SC6","C6_QTDVEN")),oFtC09)
		oPrint:Say(nLin,1900,(cAlias)->C6_UM,oFtC09)//oPrint:Say(nLin,0530,(cAlias)->C6_UM,oFtC09)
		
		aDesc := aClone(QuebraStr((cAlias)->C6_DESCRI,50))
	...
	oPrint:Say(nLin,1480,'QTD PRODUTOS:',oFtA10n)
	oPrint:Say(nLin,1800,cValtochar(nQtPro),oFtC09)
